				...
				<div class="thread">
						<div class="row topic">
							...
							<div class="col-xs-11">
								...
								<p class="info">
									<a href="{{URL::to('user/'.$support_ticket->reporterId)}}" class="name"><strong>{{$support_ticket->reporter}}</strong></a>
									<span class="name">ร้องเรียน</span>
									<a href="{{URL::to('user/'.$support_ticket->reporteeId)}}" class="name"><strong>{{$support_ticket->reportee}}</strong></a>
