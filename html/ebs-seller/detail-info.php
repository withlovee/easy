...
<table class="table table-striped table-bordered item-info">
	...
	<tr>
		<th>คุณสมบัติ</th>
		<td>เรียกกันอีกชื่อง่ายๆคือ one touch silicone stand เพียงแค่กดเบาๆก็สามารถ งอและวางบนนิ้วมือหรือตั้งเพื่อดูได้ บอกเลยว่าน่ารักสุดๆ ไม่มีนี่พลาดมากอะ !!!<br><br>ไอเท็มเพื่อเพิ่มลูกเล่นในการถ่ายภาพด้วยเลนส์เสริมสำหรับติดโทรศัพท์มือถือ สามารถถ่ายภาพแบบมุมกว้าง, กลมนูนแบบฟิชอาย หรือขยายเพื่อถ่ายระยะใกล้ได้ง่ายดายจากโทรศัพท์มือถือของคุณ ใช้ได้กับทุกรุ่นและยี่ห้อ...ห้ามพลาดนะคะ!</td>
	</tr>
</table>
<!-- /.table -->
<br><br>
...
<table class="table table-striped table-bordered item-info">
	...
	<tr>
		...
		<td>
			แบบด่วน: 100 บาท<br>
			แบบมาตรฐาน: 50 บาท<br>
			แบบประหยัด: 30 บาท</td>
	</tr>
	<tr>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
	...
	<div class="panel panel-default">
		...
		<div id="q2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
			<div class="panel-body">
				<label for="">ตอบคำถาม</label>
				<textarea name="" id="" cols="30" rows="2" class="form-control" placeholder="คำตอบ"></textarea>
				<br>
				<input type="text" class="btn btn-primary btn-sm" value="ตอบคำถาม">
			</div>
		</div>
	</div>
</div>