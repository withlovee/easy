...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">ขายสินค้า <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="sell-auction.php">ประมูล</a></li>
					<li><a href="sell-direct.php">ขายโดยตรง</a></li>
				</ul>
			</li>
			<li>
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">สวัสดี! วิภาวี ไตรรัตนาภา (veevee) <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="edit_profile.php">แก้ไขข้อมูลส่วนตัว</a></li>
					<li><a href="member_profile.php">ดู Feedback</a></li>
					<li><a href="transactions.php">ดูประวัติการขาย</a></li>
					<li class="divider"></li>
