			...
			<div class="col-md-9 content-wrapper content-white">
				...
				<form class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="name" class="form-control" placeholder="ชื่อจริง" value="วิภาวี" required>
						</div>
						<div class="col-sm-4">
							<input type="name" class="form-control" placeholder="นามสกุล" value="ไตรรัตนาภา" required>
						</div>
					</div><!--form-group-->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="email" class="form-control" placeholder="your-email@email.com" value="veevee.t@gmail.com" required>
						</div>
